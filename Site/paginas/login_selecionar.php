...
<html lang="pt-br">
  ...
  <body>    
    ...
    <div class="container-xl">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#conteudoNavbarSuportado" aria-controls="conteudoNavbarSuportado" aria-expanded="false" aria-label="Alterna navegação">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu " aria-labelledby="navbarDropdown">
              <a class="dropdown-item active" href="login_selecionar.php">Login</a>
              <a class="dropdown-item " href="registrarselecionar.php">Cadastre-se</a>
     ...
     <hr>
     <div id="icon_reg">
        <img id="registrar_icone" src="../imgs/logar_icon.png" alt="">
    
    </div>
         
    <div class="container containerbotoes" href="logarempresa.php" >
            
        <a href="loginempresa.php" id="at">
            <div id="logarempresa" class="btn_selecionar">
                <i class="fas fa-building icon" ></i>
                <br>

                <p class="logar">Logar Como Empresa</p>
            </div>
        </a>
        <a href="login.php" id="at">
            <div id="logarusuario" class="btn_selecionar">
                <i class="fas fa-user icon"></i>
                <br>

                <p class="logar">Logar Como Aluno</p>
