  ...
  <body >
    ...
    <div class="container-xl">
      ...
      <div id="botao">
        ...
        <a class ="hrefs" href="configempresa.php">
        ...
        <a class ="hrefs"  href="cadastrarvagas.php">
          <div class="botoes_usuario">
           <p class="p">Cadastrar Vaga</p>
        
          </div> 
        </a>    
        <a class ="hrefs"  href="vagas_cadastradas.php">
           <div class="botoes_usuario">
            <p class="p">Vagas Cadastradas</p>

        </div>
         </a>  
         <a class ="hrefs ultimo_botao"  href="perguntas_respondidas_emp.php">
