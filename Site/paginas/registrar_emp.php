...
<html lang="pt-br">
  ...
  <body >
          ...
          <a class="nav-link" href="Fale_conosco.php">Fale Conosco</a>
            ...
            <li class="nav-item dropdown">
              ...
              if((isset($_SESSION['usuarioatual']))){
                ...
                echo"<a class='dropdown-item' href='../paginas/login.php'>Login</a>
                <a class='dropdown-item' href='../paginas/cadastre-se.php'>Cadastre-se</a>";
    ...
    <div class="container">
        <form action="../conexoes/cadastraremp.php" method="POST">
            <div class="form-group row">
              <label  class="col-sm-2 col-form-label"for="nomeemp">Nome da Empresa:</label>
              
              <input style="min-width:44vw;" type="text" class="form-control col-sm-2 col-form-label"  name="nomeemp" id="nomeemp" required>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"for="cnpj">CNPJ</label>
                
                <input style="min-width:44vw" type="text" class="col-sm-2 col-form-label form-control"  name="cnpj" id="cnpj" required>
              </div>
              <div class="form-group row">
                  <label class=" col-sm-2 col-form-label" for="empcidade">Cidade Empresa</label>
                  <br>
                  <input style="min-width:44vw"  type="text" class="col-sm-2 col-form-label form-control"  name="empcidade" id="empcidade" required>
                </div>
            <div class="form-group row">
              <label class="col-sm-2 col-form-label" for="empendereco">Endereço da Empresa:</label>
              <br>
              <input style="min-width:44vw"  type="text" class="form-control col-sm-2 col-form-label"  name="endereco" id="endereco" required>
            </div>
            <div class="form-group row">
              <label class="col-sm-2 col-form-label" for="emp_cep">CEP:</label>
              <br>
              <input style="min-width:44vw"  type="text" class="form-control col-sm-2 col-form-labell"  name="emp_cep" id="emp_cep" required>
            </div>
            <div class="form-group row" >
            ...
            <div class="form-group row" >
              ...
              <br>
              <input style="min-width:44vw"  type="text" class="form-control col-sm-2 col-form-labell"  name="emp_resp" id="emp_resp" required>
